...
We are going to be working through a series of tasks and also complete some exercises indicated by **Exercise**. The best way to do this is to create an Quarto document and work through the tasks and complete the exercises. Each time document your answers/notes so that when you revisit the prac during your study for the mid-semester test and final exam, that it is clear what you have done and what the meaning of the output is.
...
## Now it's your turn Describing a soil dataset
